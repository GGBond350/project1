					...
					<div class="choose">
						<div class="chooseArea">
							...
							<dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
								...
								<dd changepirce="0" :class="{ active: value.isChecked === '1' }"
									...
									@click="change(value, spuSaleAttr.spuSaleAttrValueList)">{{ value.saleAttrValueName }}</dd>
							</dl>
						...
						<div class="cartWrap">
							<div class="controls">
								...
								<a href="javascript:" class="mins" @click="count < 2 ? 1 : count--">-</a>
							</div>
							<div class="add">
...
export default {
	...
	mounted() {
		this.$store.dispatch('detailInfo', this.$route.params.skuid)
	},
	data() {
		return {
			count: 1
	...
	methods: {
		...
		async addShopcar() {
			...
			try {
				await this.$store.dispatch('addToCart', { skuId: this.$route.params.skuid, skuNum: this.count })
